    ...
    View v;
        ...
        container, @Nullable Bundle savedInstanceState){
            ...
            if(!isConnected(getActivity())){ buildDialog(getActivity()).show();}
                ...
                URL searchURL = buildUrl();//URL is a class
        ...
        public void onCreateOptionsMenu (Menu menu, MenuInflater menuInflater){
            ...
            searchView = (SearchView) searchItem.getActionView();//Returns the currently set action view for this menu item.
        ...
        public static String getResponseFromHttpUrl (URL url) throws IOException {
            ...
            try {
                ...
                boolean hasInput = scanner.hasNext();//returns true if scanner has next token in input
                if (hasInput) {
                    return scanner.next();//returns next token
                } else {
                    return null;
                }
            } finally {
